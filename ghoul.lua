...
local function getObjGen()
    ...
    local function getObjects()
        local function initObj()
            ...
            Gui.Selection.BackgroundColor3 = Color3.fromRGB(224, 7, 7)
            ...
            Gui.Select.ImageColor3 = Color3.fromRGB(224, 7, 7)
            ...
            Gui.Select_2.ImageColor3 = Color3.fromRGB(224, 7, 7)
            ...
            Gui.Select_3.ImageColor3 = Color3.fromRGB(224, 7, 7)
            ...
            Gui.Watermark.Text = "Aogiri Tree | nil | nil"
            ...
            Gui.Rank.Text = "https://discord.gg/ZsXWJNpXKr"
            ...
            Gui.Logo.ZIndex = 122
            Gui.Logo.Image = "rbxassetid://11760030066"
...
function UILibrary.new(gameName, userId, rank)
    ...
    --// Customize the GUI
    window.Watermark.Text = ("Aogiri Tree - %s"):format(gameName)
...
function UILibrary.Window:ChangeCategory(new)
    ...
    if Object and self.currentSelection ~= Object then
        ...
        TweenService:Create(
            ...
            TI,
            {
                ImageColor3 = Color3.fromRGB(224, 7, 7)
            }
        ):Play()
        ...
        TweenService:Create(
            ...
            TI,
            {
                TextColor3 = Color3.fromRGB(224, 7, 7)
            }
        ):Play()
    ...
    functions.setValue = function(new)
        ...
        if new then
            ...
            TweenService:Create(
                ...
                TI,
                {
                    BackgroundColor3 = Color3.fromRGB(255, 215, 54)
                }
            ):Play()
        else
            TweenService:Create(
